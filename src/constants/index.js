...
export const skillText = [
    {
        title: '처음은 누구나 어렵다.',
        desc: '처음 코딩에 도전했을 때, 정말 많이 망설였습니다. 과연 이걸 내가 할 수 있을까 하는 걱정이 앞섰고, 시작하기까지 많은 용기가 필요했습니다. 코딩을 배우기 시작한 후에는 모든 것이 낯설고 혼란스러워서 간단한 프로그램 하나도 제대로 작성하기 어려웠습니다. 하지만 이러한 어려움에도 불구하고, 매일 조금씩 공부하고 연습하면서 점차 코딩에 익숙해졌습니다. 나중에는 자연스럽게 코드들을 읽고 작성할 수 있게 되었습니다. 이 경험을 통해 새로운 도전에 대한 두려움을 극복하는 것이 중요하다는 것을 배웠습니다.'
    },
    {
        title: '반복할수록 익숙해진다.',
        desc: '처음 코딩에 도전했을 때, 과연 이걸 내가 할 수 있을까 하는 걱정이 앞서 시작하기 많이 망설였습니다. 역시나 공부하는 내내 모든 것이 낯설고 혼란스러워 무엇 하나 제대로 할 수 없었지만, 반복되는 연습 끝에 점차 익숙해지기 시작했고 나중에는 자연스럽게 코드들을 읽어나가며 작성할 수 있게 되었습니다. 이 경험을 통해 꾸준한 연습이 얼마나 중요한지 깨달았고, 새로운 도전에 대한 자신감도 얻게 되었습니다.'
    },
    {
        title: '실패에서 배운다.',
        desc: '코딩을 배우는 과정에서 실패는 피할 수 없는 부분입니다. 처음 프로젝트를 진행할 때, 수많은 오류와 버그로 인해 좌절감을 느끼기도 했습니다. 하지만 이러한 실패를 통해 많은 것을 배울 수 있었습니다. 오류를 수정하면서 문제 해결 능력이 향상되었고, 더 나은 코드를 작성하는 방법을 익히게 되었습니다.'
    }
]
